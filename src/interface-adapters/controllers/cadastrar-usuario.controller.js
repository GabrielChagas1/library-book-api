...
module.exports = async function cadastrarUsuarioController({cadastrarUsuarioUseCase, httpRequest}){

  const checaDependecias = !cadastrarUsuarioUseCase || !httpRequest || !httpRequest.body;

  if(checaDependecias) throw new AppError(AppError.dependecias)
